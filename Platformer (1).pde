...
final static float Teach_Scale=100.0/226;
...
mentor1= new Sprite("playerLvl2.png",1.0,1600,2100);
mentor2= new Sprite("teach4.png",Teach_Scale,3200,2100);
p=new Sprite("Player.png", 0.5);
home_screen= new Sprite("home.png",0.8,950,650);
resume = new Sprite("resume.png",1.0,p.center_x+950,mentor1.center_y-315);
win1 = new Sprite("win2.png",1.0,view_x+950,view_y+500);
bar_of_know=0;
p.setBottom(800);
p.center_x= 100;
p.change_x=0;
...
enemy1 = new Sprite("badguy1.png",0.5);
enemy1.center_x=340;
enemy1.setBottom(1047);
enemy1.change_x=0;
enemy2= new Sprite("badguy2.png",0.5);
enemy2.center_x=990;
enemy2.setBottom(1047);
enemy2.change_x=0;
enemy3 = new Sprite("badguy3.png",0.5);
enemy3.center_x=1500;
enemy3.setBottom(1047);
enemy3.change_x=0;
enemy4=new Sprite("badguy4.png",0.5);
enemy4.center_x=2250;
enemy4.setBottom(1047);
enemy4.change_x=0;
enemy5=new Sprite("badguy1.png",0.5);
enemy5.center_x=390;
enemy5.setBottom(1047);
enemy5.change_x=0;
enemy6=new Sprite("badguy3.png",0.5);
enemy6.center_x=1500;
enemy6.setBottom(1047);
enemy6.change_x=0;
enemy7=new Sprite("badguy2.png",0.5);
enemy7.center_x=1450;
enemy7.setBottom(1047);
enemy7.change_x=0;
enemy8=new Sprite("badguy1.png",0.5);
enemy8.center_x=2250;
enemy8.setBottom(1047);
enemy8.change_x=0;
enemy9=new Sprite("badguy4.png",0.5);
...
win= new Sprite("win.png",1.0,view_x+950,view_y+500);
lose = new Sprite("lose.png",1.0,view_x+950,view_y+500);
green1 = 0;
green2 =0;
green3=0;
green4=0;
...
void mouseClicked(){
 ...
 if((mouseX>492 && mouseX<831) && (mouseY>778 && mouseY<880) && bar_of_know<=-50.0 && isGameOver==true){
setup();
 ...
 if((mouseX>492 && mouseX<831) && (mouseY>778 && mouseY<880) && bar_of_know<=-50.0 && isGameOver==true && level2){
   p.center_x=100;
   p.setBottom(2300); 
   isGameOver=false;
   bar_of_know=0;
